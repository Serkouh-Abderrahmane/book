      ...
      <div className="hcard-body">
        ...
        <div className="hcard-foot">
          <div className="hcard-price">
            <span className="hcard-price-amount">{Number(hotel.price_from || 0).toLocaleString('vi-VN')}₫</span>
            <span className="hcard-price-unit">/đêm</span>
          </div>
        </div>
      </div>
    </article>
